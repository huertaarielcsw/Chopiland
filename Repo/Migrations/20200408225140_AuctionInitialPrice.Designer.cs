...
namespace Repo.Migrations
{
    ...
    [Migration("20200408225140_AuctionInitialPrice")]
    partial class AuctionInitialPrice
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Data.Auction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Data.AuctionUser", b =>
                {
            ...
            modelBuilder.Entity("Data.Auction", b =>
                {
                    b.HasOne("Data.Anouncement", "Announcement")
                        .WithOne("Auction")
                        .HasForeignKey("Data.Auction", "AnouncementId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("Data.AuctionUser", b =>
                {
                    b.HasOne("Data.Auction", "Auction")
